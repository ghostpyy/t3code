// This file mostly exists because we want dev mode to say "T3 Code Ernn Edition (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "T3 Code Ernn Edition (Dev)" : "T3 Code Ernn Edition";
